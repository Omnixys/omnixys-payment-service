...
import com.gentlecorp.payment.models.dto.NewPaymentIdDTO;
import com.gentlecorp.payment.models.entitys.Payment;
import com.gentlecorp.payment.models.events.LogDTO;
import com.gentlecorp.payment.models.events.SendMail;
import com.gentlecorp.payment.tracing.TraceContextUtil;
...
import static com.gentlecorp.payment.messaging.KafkaTopicProperties.TOPIC_ACTIVITY_EVENTS;
import static com.gentlecorp.payment.messaging.KafkaTopicProperties.TOPIC_INVOICE;
import static com.gentlecorp.payment.messaging.KafkaTopicProperties.TOPIC_NOTIFICATION_ACCOUNT_CREATED;
...
public class KafkaPublisherService {
    ...
    public void createInvoice(Payment savedPayment) {
        final var newPaymentDTO = new NewPaymentIdDTO(savedPayment.getId(), savedPayment.getInvoiceId());
        sendKafkaEvent(TOPIC_INVOICE, newPaymentDTO, "newPayment");
    }
