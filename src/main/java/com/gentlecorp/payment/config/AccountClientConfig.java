package com.gentlecorp.payment.config;
...
import static com.gentlecorp.payment.util.Constants.GRAPHQL_ENDPOINT;
import static com.gentlecorp.payment.util.Constants.getServiceValue;
...
sealed interface AccountClientConfig permits ApplicationConfig {
    ...
    default UriComponentsBuilder accountUriComponentsBuilder() {
        ...
        LOGGER.debug("account: schema={} host={}, port={}", values.schema(), values.host(), values.port());
